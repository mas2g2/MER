...
def getPitch(filename,frate):
    ...
    downsample = 1
    samplerate = int(frate / downsample)
    window = int(1024 / downsample) # fft size

    hopsize = int(256/ downsample)
...
if __name__=="__main__":
    print(getPitch("/home/vyassu/PycharmProjects/DeepSentiment/Data/sp04.wav",int(8000)))
